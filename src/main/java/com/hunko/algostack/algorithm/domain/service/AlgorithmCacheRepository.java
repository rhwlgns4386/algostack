...
public interface AlgorithmCacheRepository extends JpaRepository<AlgorithmCache, Long> {
    Optional<AlgorithmCache> findByUserIdAndAlgorithmIdAndSolvedDate(Long userId, AlgorithmId algorithmId, LocalDate solvedDate);
    ...
    @Query("""
            ...
            """)
    List<AlgorithmCache> findByUserIdAndRange(Long userId, LocalDate startDate, LocalDate endDate);
}
